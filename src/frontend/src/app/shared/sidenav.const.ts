...
const adminSideNav: any[] = [
  { type: 1, a: { link: 'reportform/overview', title: 'MENU.PLATFORM_OVERVIEW', text: 'MENU.PLATFORM_OVERVIEW', icon: { shape: 'help-info' } } },
  { type: 3 },
  {
    type: 2, icon: { shape: 'world', title: 'Kubernetes', solid: true }, text: 'Kubernetes', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.SYSTEM_STATISTICS', shape: 'image-gallery' }, text: 'MENU.SYSTEM_STATISTICS', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.CONFIGURATION', shape: 'cog' }, text: 'MENU.CONFIGURATION', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.PERMISSION', shape: 'users' }, text: 'MENU.PERMISSION', name: 'system', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.DEPLOYMENT', shape: 'event' }, text: 'MENU.DEPLOYMENT', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.STATEFULSET', shape: 'blocks-group' }, text: 'MENU.STATEFULSET', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.DAEMONSET', shape: 'layers' }, text: 'MENU.DAEMONSET', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.CRONJOB', shape: 'clock' }, text: 'MENU.CRONJOB', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.AUTO_POD_SCALE', shape: 'cloud-scale' }, text: 'MENU.AUTO_POD_SCALE', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.SERVICE', shape: 'network-globe' }, text: 'MENU.SERVICE', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.EDGE_NODE_ABOUT', shape: 'cloud-traffic' }, text: 'MENU.EDGE_NODE_ABOUT', name: 'edge-node', child: [
  ...
  {
    type: 2, icon: { title: 'Ingress', shape: 'network-switch' }, text: 'Ingress', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.CONFIGMAP', shape: 'file-settings' }, text: 'MENU.CONFIGMAP', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.SECRET', shape: 'certificate' }, text: 'MENU.SECRET', child: [
  ...
  {
    type: 2, icon: { title: 'MENU.PVC', shape: 'storage' }, text: 'MENU.PVC', child: [
  ...
  { type: 3 },
  {
    type: 2, icon: { title: 'MENU.NOTIFICATION_AUDIT', shape: 'bell', solid: true }, text: 'MENU.NOTIFICATION_AUDIT', child: [
