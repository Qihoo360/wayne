...
# meta.) Assumes you care about pulls from remote "origin" and
# checks them out to a branch named:
# automated-cherry-pick-of-<pr>-<target branch>-<timestamp>
# export FORK_REMOTE=fork
# export UPSTREAM_REMOTE=origin
# export GITHUB_USER=github_user
# ./cherry_pick_pull.sh release/v1.2 180
...
if [[ "$#" -lt 2 ]]; then
  ...
  echo "  Examples:"
  echo "    $0 origin/release-3.14 12345        # Cherry-picks PR 12345 onto origin/release-3.14 and proposes that as a PR."
  echo "    $0 origin/release-3.14 12345 56789  # Cherry-picks PR 12345, then 56789 and proposes the combination as a single PR."
  echo
  ...
  echo
  echo " Set UPSTREAM_REMOTE (default: origin) and FORK_REMOTE (default: fork)"
